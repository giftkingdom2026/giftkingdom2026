                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name" class="control-label">{{ trans('labels.Category') }}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group homeCheckBox">
                                                    <label for="name" class="control-label">Home</label>
                                                ...
                                                <!-- <div class="form-group">
                                                  <label for="name" class="control-label">{{ trans('labels.ShowOnSellPage') }} </label>
                                                  ...
                                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                  {{ trans('labels.ShowOnSellPage') }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="control-label">{{ trans('labels.Description') }}({{ $languages->name }})</label>
                                                        ...
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Sub Category Description  ({{ $languages->name }}).</span>
                                                            <span class="help-block hidden">Sub Category Description </span>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name" class="control-label">Svg</label>

                                                        <textarea id="editor" name="svg" class="form-control" 
