...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Import CSV<small>CSV...</small> </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/products/get/csv/data', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Select CSV</label>
