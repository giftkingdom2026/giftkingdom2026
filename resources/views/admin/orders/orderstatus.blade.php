...
@section('content')
    <div class="content-wrapper content-wrapper1">
        ...
        <section class="content-header">
            <h1>  Order Status <small> Listing Order Status...</small> </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Listing Order Status </h3>
                            <div class="box-tools pull-right">
                                <a href="addorderstatus" type="button" class="btn btn-block btn-primary">+</a>
                            </div>
                        </div>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach ($result['orders_status'] as $OrderStatus)
                                            <tr>
                                                ...
                                                <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editorderstatus/{{ $OrderStatus->orders_status_id }}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
