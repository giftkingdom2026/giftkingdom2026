                ...
                <div class="col-md-12">
                                        ...
                                        @if( count($errors) > 0)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text(1000,  1000, array('class'=>'form-control number-validate', 'id'=>1000, 'name'=>'ThumbnailHeight')) !!}
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text(1000,  1000, array('class'=>'form-control number-validate', 'id'=>1000, 'name'=>'ThumbnailWidth')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text(1000,  1000, array('class'=>'form-control number-validate', 'id'=>1000, 'name'=>'MediumHeight')) !!}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text(1000,  1000, array('class'=>'form-control number-validate', 'id'=>1000, 'name'=>'MediumWidth')) !!}
                    ...
                    <!-- /.box-body -->
                        <div class="box-footer text-center">
                            ...
                            <button type="submit" class="btn btn-primary" id="regenrate" name="regenrate" value="yes">{{ trans('labels.SaveRegenerate') }}</button>
                            <a href="{{ URL::to('admin/dashboard/this_month')}}" type="button" class="btn btn-primary">{{ trans('labels.back') }}</a>
                        </div>
                </div>
                <!-- /.box -->
            </div>
