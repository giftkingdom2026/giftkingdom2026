...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Page Seo <small>Page Seo...</small> </h1>
            <ol class="breadcrumb">
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <input type="hidden" name="post_type" 
                                                    value="pages">
                                                  <input type="hidden" name="old_slug" 
                                                    value="{{$result['pages']->slug}}">
                                                    <input type="hidden" name="page_name" class="form-control " 
                                                    value="{{$result['pages']->title}}"
                                                    >
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Meta {{ trans('labels.Description') }} </label>
                                                    <div class="col-sm-10 col-md-8">
                                                      <textarea id="editor1" name="meta_description" class="form-control field-validate" rows="10" cols="80">
                                                        @if(!empty($result['seo'][0]))  {{$result['seo'][0]->meta_description}} @endif
                                                      </textarea>
                                                 ...
                                                 <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Meta Keywords</label>
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="meta_keywords" class="form-control" 
                                                         @if(!empty($result['seo'][0])) 
                                                        value="{{$result['seo'][0]->meta_keywords}}"
                                                        @endif
                                                        >
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                        Meta Keywords</span>
                                                 ...
                                                 <hr>
                                                <div class="form-group">
                                                	<label for="name" class="col-sm-2 col-md-3 control-label">OG:Title</label>
                                                	<div class="col-sm-10 col-md-4">
                                                		<input type="text" name="og_title" class="form-control " 
                                                         @if(!empty($result['seo'][0])) 
                                                        value="{{$result['seo'][0]->og_title}}"
                                                        @endif
                                                        >
                                                		<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                		OG:Title </span>
                                                ...
                                                <div class="form-group">
                                                	<label for="name" class="col-sm-2 col-md-3 control-label">OG: {{ trans('labels.Description') }} </label>
                                                	<div class="col-sm-10 col-md-8">
                                                		<textarea id="editor1" name="og_description" class="form-control " rows="10" cols="80">
                                                			 @if(!empty($result['seo'][0])) {{$result['seo'][0]->og_description}}@endif
                                                		</textarea>
                                                		<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Description') }} </span>
                                                		<br>
                                                	</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <img src="{{asset($result['seo'][0]->path)}}" alt="" width=" 100px">
                                                </div>
                                            </div>
                                                    @endif
                                            <hr>
