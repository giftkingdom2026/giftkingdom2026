                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="control-label">{{ trans('labels.PageName') }} ({{ $languages->name }}) </label>
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="form-group show-image" id="imageIcone">
                                          ...
                                          @foreach($result['languages'] as $languages)
                                                ...
                                                <div class="form-group">
                                                    <label for="name" class="control-label">{{ trans('labels.Description') }} ({{ $languages->name }}) </label>
                                                        ...
                                                        <textarea id="editor<?=$languages->languages_id?>" name="description_<?=$languages->languages_id?>" class="form-control summernote" rows="10" cols="80">
                                                        </textarea>
