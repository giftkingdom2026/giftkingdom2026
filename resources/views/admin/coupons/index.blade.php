...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=asset('admin/coupons/add')?>" type="button" class="btn-block"><i class="fa fa-plus"></i>Add Coupon</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="multi-delete" style="display: none;">
                                ...
                                <a href="javascript:delete_popup('<?=asset('admin/coupons/delete')?>','');" 
