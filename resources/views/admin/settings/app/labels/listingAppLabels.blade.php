                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <!-- <div class="box-tools pull-right">
                                <a href="{{'addappkey'}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNewLabel') }}</a>
                            </div> -->
                        </div>
                                        ...
                                        @if(count($result['labels'])>0)
                                            @foreach ($result['labels'] as $key=>$label)
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editAppLabel/{{ $label->label_id }}" class="badge bg-light-blue"><i class="fa-solid fa-pen" aria-hidden="true"></i></a>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
