                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <a href="{{ URL::to('admin/tax/taxrates/add')}}" type="button" class="btn btn-block btn-primary">+</a>
                                        ...
                                        @foreach ($result['tax_rates'] as $key=>$taxRate)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <strong>{{ trans('labels.AddedDate') }}: </strong>{{date('Y-m-d', strtotime($taxRate->created_at))}}<br>

                                                    

                                                </td>

                                                <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ URL::to('admin/tax/taxrates/edit/'.$taxRate->tax_rates_id) }}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
