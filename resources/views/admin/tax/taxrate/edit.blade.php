                                    ...
                                    <!-- form start -->
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="control-label">{{ trans('labels.TaxClass') }}*  </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="control-label">{{ trans('labels.Zone') }}*
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="control-label">{{ trans('labels.AddTaxRatePercentage') }}*
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class="control-label">{{ trans('labels.Description') }}
