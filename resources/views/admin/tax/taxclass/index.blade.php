                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <a href="{{url('admin/tax/taxclass/add')}}" type="button" class="btn btn-block btn-primary">+</a>
                                        ...
                                        @foreach ($tax_class as $key=>$data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <strong>{{ trans('labels.AddedDate') }}: </strong>{{date('Y-m-d', strtotime($data->created_at)) }}<br>

                                                    

                                                </td>

                                                <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/tax/taxclass/edit/'. $data->tax_class_id) }}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
