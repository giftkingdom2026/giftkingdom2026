                                        ...
                                        @if(count($countryData['countries'])>0)
                                            ...
                                            @foreach ($countryData['countries'] as $key=>$countries)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{url('admin/countries/edit',$id)}}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
