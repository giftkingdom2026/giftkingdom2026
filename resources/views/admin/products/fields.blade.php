<div class="row">
    ...
    <div class="col-md-8">
        ...
        <div class="form-group mt-3">
            ...
            $prod_features = isset($data['meta']['prod_features']) ? $data['meta']['prod_features'] : ''; ?>

            <textarea class="quilleditor" name="meta[prod_features]" height="350"><?=$prod_features?></textarea>

        </div>



        <?php $class = isset($data['variations']) ? '' : 'd-none'; ?>

        <div id="variations" class="my-3 <?=$class?>">
    ...
    <div class="col-md-4">
        ...
        <div class="position-sticky top-0">
            ...
            <div class="form-group mt-3 d-none">
                ...
                <label for="bought_together" class="control-label mb-1">Bought Together</label>

                <?php

                $arr = isset($data['meta']['bought_together']) ? explode(',', $data['meta']['bought_together']) : []; ?>

                <select name="meta[bought_together][]" id="bought_together" multiple class="form-control select2">

                    <?php

                    foreach( $data['products'] as $rel ) : 

                        $attr = in_array($rel['ID'], $arr) ? 'selected' : '';?>

                        <option <?=$attr?> value="<?=$rel['ID']?>"><?=$rel['prod_title']?></option>
            ...
            if( isset($data['brands']) ) : ?>
                ...
                <div class="brands d-none mt-3 border p-2">
                    <h3>Brand</h3>
