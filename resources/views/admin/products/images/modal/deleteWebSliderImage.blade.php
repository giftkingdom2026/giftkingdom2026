...
{!! Form::open(array('url' =>'admin/web_slider_products/images/deleteproductimage', 'name'=>'deleteImageForm', 'id'=>'deleteImageForm', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
