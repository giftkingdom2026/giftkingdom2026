                                            ...
                                            <div class="col-xs-4 col-md-2 margin-bottomset" >
                                                ...
                                                <div class="thumbnail">
                                                    ...
                                                    <div class="caption">
                                                      ...
                                                      <a class="badge bg-light-blue editProductImagesModal"  href="{{url('admin/products/images/editproductimage/')}}/{{$products_image->id}}" ><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
