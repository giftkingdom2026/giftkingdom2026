...
@section('content')
    <div class="content-wrapper content-wrapper1">
        ...
        <section class="content-header">
            <h1> Sizes <small>Listing All Sizes...</small> </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="col-lg-6 form-inline">
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/size/filter')}}" style="opacity: 0;visibility: hidden;">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        @if(isset($param,$name))  <a class="btn btn-danger " href="{{url('admin/size/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                    </div>
                                </form>
                                <div class="col-lg-4 form-inline" id="contact-form12"></div>
                            </div>
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/size/add')}}" type="button" class="btn btn-block btn-primary">+</a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped mt-2">
                                        <thead>
                                        <tr>
                                            <th>@sortablelink('size_id', trans('labels.ID') )</th>
                                        ...
                                        <tbody>
                                        @if(count($size)>0)
                                            @php $sizeunique = $size->unique('id'); @endphp
                                            @foreach ($size as $key=>$category)
                                                    <tr>
                                                        <td>{{ $category->id }}</td>
                                                        ...
                                                        <td>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{url('admin/size/edit/'. $category->id) }}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/size/delete', 'name'=>'deleteBanner', 'id'=>'deleteBanner', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
