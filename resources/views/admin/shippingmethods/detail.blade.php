                                            ...
                                            @foreach($result['description'] as $description_data)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        ...
                                                        <input type="text" name="name_<?=$description_data['languages_id']?>" class="form-control field-validate" value="{{$description_data['name']}}" readonly="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        ...
                                                        <input type="number" name="price" class="form-control field-validate" value="{{$result['shppingMethods'][0]->price}}">

                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Shipping Price.</span>

                                                        <span class="help-block hidden">Shipping Price.</span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                            ...
                                                            @foreach($result['city'] as $row)
                                                                @if($row->id == $result['shppingMethods'][0]->city)
                                                                    <input type="text" class="form-control" readonly="" value="{{$row->name}}">
                                                                @endif
                                                            @endforeach
                                                        <input type="hidden" class="form-control" name="city" value="{{$result['shppingMethods'][0]->city}}">

                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">City.</span>

                                                        <span class="help-block hidden">City.</span>
