                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="shippingEnvironment" class=" col-md-12 control-label" style="">{{ trans('labels.TestProductionMode') }}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.ShippingServiceType') }}</label>
...
{{--{{ trans('labels.ShippingTitleText') }}</span>--}}
                                            ...
                                            @foreach($result['description'] as $description_data)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.NextDayAir') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.2ndDayAir') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.Ground') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.3DaySelect') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.NextDayAirSaver') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.NextDayAirEarlyAM') }} ({{ $description_data['language_name'] }})</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class=" col-md-12 control-label">{{trans('labels.2ndDayAirAM') }} ({{ $description_data['language_name'] }})</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.AccessKey') }}</label>
                                    ...
                                    {{ trans('labels.AccessKeyText') }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.UserName') }}</label>
                                    ...
                                    {{ trans('labels.UPSSshippingPassword') }}.</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="shippingEnvironment" class=" col-md-12 control-label" style="">{{ trans('labels.PickupMethod') }} :</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.Address') }}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.State') }}</label>
                                    ...
                                    {{ trans('labels.StateShippingText') }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.Postcode') }}</label>
                                    ...
                                    {{ trans('labels.CityShippingText') }}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="name" class=" col-md-12 control-label">{{ trans('labels.City') }}</label>
