...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add Tag<small>Adding Tag...</small> </h1>
            <ol class="breadcrumb">
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/tags/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <input type="text" name="tag" class="form-control field-validate">
