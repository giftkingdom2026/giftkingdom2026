...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Tags<small>Listing All The Tags...</small> </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="col-lg-6 form-inline">
                                ...
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('admin/news/filter')}}" style="display: none">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/tags/add')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @if($news != null)
                                            ...
                                            @php $newslist = $news->unique('tag_id') @endphp
                                            @foreach ($newslist as  $key=>$new)

                                                <tr>
                                                    <td>{{ $new->tag_id }}</td>
                                                    <td>
                                                        <strong>{{ $new->tag_name }}</strong>
                                                    </td>
                                                    

                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ URL::to('admin/tags/edit/'.$new->tag_id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

                                                        <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteNewsId" news_id="{{ $new->tag_id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
            ...
            <div class="modal fade" id="deleteNewsModal" tabindex="-1" role="dialog" aria-labelledby="deleteNewsModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'admin/tags/delete', 'name'=>'deleteNews', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
