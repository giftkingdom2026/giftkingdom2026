                                            ...
                                            <div class="row">
                                                ...
                                                @endforeach
                                                 ...
                                                 <div class="col-xs-6">
                                                    <div class="form-group">
                                                         <label for="name"
                                                            class="col-sm-2 col-md-4 control-label">Price</label>
                                                            <div class="col-sm-10 col-md-8">
                                                                <input type="number" name="price"  class="form-control field-validate" 
                                                                value="{{$result['commonContent']['setting']['cash_on_delivery_price']}}" cols="30" rows="2">
                                                            
                                                            <span class="help-block"
                                                                style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Price
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
