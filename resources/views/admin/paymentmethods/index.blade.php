                                        ...
                                        <tbody>
                                          @foreach($result['methods'] as $method)
                                                <tr>
                                                    ...
                                                    <td>{{$method->name}}</td>
                                                    <td>
                                                        <a href="{{url('admin/paymentmethods/display')}}/{{$method->payment_methods_id}}" class="badge bg-light-blue"><i class="fa fa-regular fa-pen-to-square" aria-hidden="true"></i></a>
