...
class Manufacturers extends Model
{
  public function __construct()
  {
    ...
    public function insert($request){
          ...
          $languages_id 	=  '1';
          if(isset($request->is_shop) && $request->is_shop != ''){
            $is_shop=1;
          }else{
            $is_shop=0;
          }
    ...
    public function edit($manufacturers_id){
        ...
        $editManufacturer = DB::table('manufacturers')
            ...
            ->select('manufacturers.manufacturers_id as id', 'manufacturer_image as image',  'manufacturers.manufacturer_name as name','manufacturers.is_shop', 'manufacturers_info.manufacturers_url as url', 'manufacturers_info.url_clicked', 'manufacturers_info.date_last_click as clik_date', 'manufacturers.manufacturers_slug as slug','image_categories.path as path')
