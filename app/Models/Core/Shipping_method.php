...

{
    ...
    public function flateRate(){
        ...
        $flate_rate = DB::table('flate_rate')->where('id','=','1')->first();

        return $flate_rate;

    }
    public function flateRate2(){

        $flate_rate = DB::table('flate_rate')->where('id','=','2')->first();
    ...
    public function updateShippingNew($table_name,$price,$city){
         $shipping_methods =  DB::table('shipping_methods')->where('table_name','=',$table_name)->update([
            'city'                   =>   $city,
            'price'                   =>   $price,
    ...
    public function ifcheckIsSet($table_name,$languages_data_id,$re_name,$city,$price){
