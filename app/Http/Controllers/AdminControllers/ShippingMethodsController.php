...
class ShippingMethodsController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        // $flate_rate['flate_rate'] = $this->Shipping_method->flateRate2();
        // $flate_rate['flatrate_description'] = $this->Shipping_method->flateRateDescription();
        // $result['flate_rate2'] = $flate_rate;
    ...
    public function update(Request $request)
    {
        ...
        // foreach ($languages as $languages_data) {
            ...
            $languages_data_id = '1';
            $ifcheckis =  DB::table('shipping_description')->where('table_name','=',$table_name)->update([
                'name'                   =>   $re_name,
            ]);
        // }
